#############################################################################
# Makefile for building: vnote
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  vnote.pro
# Template: subdirs
# Command: D:\Qt\5.15.2\msvc2019_64\bin\qmake.exe -o Makefile vnote.pro -spec win32-msvc "CONFIG+=qtquickcompiler"
#############################################################################
...
sub-libs-qmake_all:  FORCE
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	cd libs\ && $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler"
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && $(MAKE) -f Makefile qmake_all
sub-libs: $(MAKEFILE) FORCE
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile
...
sub-libs-all: FORCE
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile all
sub-libs-clean: FORCE
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile clean
sub-libs-distclean: FORCE
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile distclean
sub-libs-install_subtargets: FORCE
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile install
sub-libs-uninstall_subtargets: FORCE
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile uninstall
sub-src-qmake_all: sub-libs-qmake_all FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler"
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && $(MAKE) -f Makefile qmake_all
sub-src: $(MAKEFILE) sub-libs FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile
sub-src-make_first: sub-libs-make_first FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile 
sub-src-all: sub-libs-all FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile all
sub-src-clean: sub-libs-clean FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile clean
sub-src-distclean: sub-libs-distclean FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile distclean
sub-src-install_subtargets: sub-libs-install_subtargets FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile install
sub-src-uninstall_subtargets: sub-libs-uninstall_subtargets FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile uninstall
sub-tests-qmake_all: sub-libs-qmake_all FORCE
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	cd tests\ && $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler"
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && $(MAKE) -f Makefile qmake_all
sub-tests: $(MAKEFILE) sub-libs FORCE
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile
sub-tests-make_first: sub-libs-make_first FORCE
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile 
sub-tests-all: sub-libs-all FORCE
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile all
sub-tests-clean: sub-libs-clean FORCE
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile clean
sub-tests-distclean: sub-libs-distclean FORCE
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile distclean
sub-tests-install_subtargets: sub-libs-install_subtargets FORCE
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile install
sub-tests-uninstall_subtargets: sub-libs-uninstall_subtargets FORCE
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile uninstall

Makefile: vnote.pro D:\Qt\5.15.2\msvc2019_64\mkspecs\win32-msvc\qmake.conf D:\Qt\5.15.2\msvc2019_64\mkspecs\features\spec_pre.prf \
		...
		vnote.pro
	$(QMAKE) -o Makefile vnote.pro -spec win32-msvc "CONFIG+=qtquickcompiler"
...
qmake_all: sub-libs-qmake_all sub-src-qmake_all sub-tests-qmake_all FORCE

make_first: sub-libs-make_first sub-src-make_first sub-tests-make_first  FORCE
all: sub-libs-all sub-src-all sub-tests-all  FORCE
clean: sub-libs-clean sub-src-clean sub-tests-clean  FORCE
distclean: sub-libs-distclean sub-src-distclean sub-tests-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-libs-install_subtargets sub-src-install_subtargets sub-tests-install_subtargets FORCE
uninstall_subtargets: sub-libs-uninstall_subtargets sub-src-uninstall_subtargets sub-tests-uninstall_subtargets FORCE

sub-libs-debug:
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile debug
sub-src-debug: sub-libs-debug
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile debug
sub-tests-debug: sub-libs-debug
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile debug
debug: sub-libs-debug sub-src-debug sub-tests-debug

sub-libs-release:
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile release
sub-src-release: sub-libs-release
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile release
sub-tests-release: sub-libs-release
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile release
release: sub-libs-release sub-src-release sub-tests-release

sub-libs-check:
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile check
sub-src-check: sub-libs-check
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile check
sub-tests-check: sub-libs-check
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile check
check: sub-libs-check sub-src-check sub-tests-check

sub-libs-benchmark:
	@if not exist libs\ mkdir libs\ & if not exist libs\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd libs\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\libs\libs.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile benchmark
sub-src-benchmark: sub-libs-benchmark
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\src\src.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile benchmark
sub-tests-benchmark: sub-libs-benchmark
	@if not exist tests\ mkdir tests\ & if not exist tests\ exit 1
	@set MAKEFLAGS=$(MAKEFLAGS)
	cd tests\ && ( if not exist Makefile $(QMAKE) -o Makefile F:\Code-C\vnote\tests\tests.pro -spec win32-msvc "CONFIG+=qtquickcompiler" ) && $(MAKE) -f Makefile benchmark
benchmark: sub-libs-benchmark sub-src-benchmark sub-tests-benchmark
